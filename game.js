...
export const STORE_ICON_URL = {
  // poções
  p_str_1: ".web/assets/store/p_str_1.png",
  p_dex_1: ".web/assets/store/p_dex_1.png",
  p_con_1: ".web/assets/store/p_con_1.png",
  p_int_1: ".web/assets/store/p_int_1.png",
  p_cha_1: ".web/assets/store/p_cha_1.png",

  // pergaminhos / selo
  scroll_xp_200: ".web/assets/store/scroll_xp_200.png",
  seal_debt: ".web/assets/store/seal_debt.png",

  // itens
  item_whey: ".web/assets/store/whey.png",
  item_creatine: ".web/assets/store/creatine.png",
  item_bottle: ".web/assets/store/bottle.png",

  // equipamentos (grupo por slot+tier) — funciona como fallback
  eq_head_C: ".web/assets/store/eq_head_C.png",
  eq_head_B: ".web/assets/store/eq_head_B.png",
  eq_head_A: ".web/assets/store/eq_head_A.png",
  eq_chest_C: ".web/assets/store/eq_chest_C.png",
  eq_chest_B: ".web/assets/store/eq_chest_B.png",
  eq_chest_A: ".web/assets/store/eq_chest_A.png",
  eq_arms_C: ".web/assets/store/eq_arms_C.png",
  eq_arms_B: ".web/assets/store/eq_arms_B.png",
  eq_arms_A: ".web/assets/store/eq_arms_A.png",
  eq_legs_C: ".web/assets/store/eq_legs_C.png",
  eq_legs_B: ".web/assets/store/eq_legs_B.png",
  eq_legs_A: ".web/assets/store/eq_legs_A.png",

  // set S (Monarca)
  eq_head_S_monarca: ".web/assets/store/eq_head_S_monarca.png",
  eq_chest_S_monarca: ".web/assets/store/eq_chest_S_monarca.png",
  eq_arms_S_monarca: ".web/assets/store/eq_arms_S_monarca.png",
  eq_legs_S_monarca: ".web/assets/store/eq_legs_S_monarca.png",
};
